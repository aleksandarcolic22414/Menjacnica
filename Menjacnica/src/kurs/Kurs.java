...
public class Kurs {
	...
	public void setDatumKursa(GregorianCalendar datumKursa) {
		if(datumKursa == null){
			System.out.println("Greska prilikom unosa datuma");
		}
		else this.datumKursa = datumKursa;
	}
	...
	public void setProdajniKurs(double prodajniKurs) {
		if(prodajniKurs <= 0)
			System.out.println("Greska prilikom unosa prodajnog kursa");
		else this.prodajniKurs = prodajniKurs;
	}
	...
	public void setKupovniKurs(double kupovniKurs) {
		if(kupovniKurs <= 0){
			System.out.println("Greska prilikom unosa kupovnog kursa");
		}
		else this.kupovniKurs = kupovniKurs;
	}
	...
	public void setSrednjiKurs(double srednjiKurs) {
		if(srednjiKurs <= 0){
			System.out.println("Greska prilikom unosa srednjeg kursa");
		}
		else this.srednjiKurs = srednjiKurs;
	}
	
	@Override
	public String toString() {
		return "Datum kursa: " + sdf.format(datumKursa.getTime()) + ", prodajni kurs: "
				+ prodajniKurs + ", kupovni kurs: " + kupovniKurs
